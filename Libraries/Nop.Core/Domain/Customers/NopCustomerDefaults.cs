...
public static partial class NopCustomerDefaults
{
    ...
    /// </summary>
    public static string CloseConfigurationStepsAttribute => "CloseConfigurationSteps";/// <summary>
    
    /// Gets a name of generic attribute to store the value of 'GiftMessage'
    /// </summary>
    public static string GiftMessage => "CustomerOrderGiftMessage";
