        ...
        async Task<PlaceOrderResult> placeOrder(PlaceOrderContainer placeOrderContainer)
        {
            ...
            try
            {
                ...
                if (processPaymentResult.Success)
                {
                    ...
                    //Gift message
                    var giftMessage = await _genericAttributeService.GetAttributeAsync<string>(details.Customer, NopCustomerDefaults.GiftMessage);
                    if (!string.IsNullOrEmpty(giftMessage))
                    {
                        ...
                        await _genericAttributeService.SaveAttributeAsync(
                            ...
                            NopCustomerDefaults.GiftMessage,
                            string.Empty);
                    }
