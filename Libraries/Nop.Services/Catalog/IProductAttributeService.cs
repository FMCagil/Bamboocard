...
public partial interface IProductAttributeService
{
    ...
    /// </summary>
    /// <param name="productAttributeName">Product attribute name; null to load all records</param>
    ...
    /// </returns>
    Task<IPagedList<ProductAttribute>> GetAllProductAttributesAsync(string productAttributeName = null, int pageIndex = 0, int pageSize = int.MaxValue);
